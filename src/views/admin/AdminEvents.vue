    ...
    <div class="bg-gray-900/50 rounded-xl border border-gray-800 p-3 md:p-4 mb-4 md:mb-6">
      ...
      <div class="flex flex-wrap items-center gap-2 md:gap-4 mt-2 border-t border-gray-800 pt-3">
        <div class="flex items-center gap-2">
          <input type="checkbox" id="ipFilterToggleEvents" v-model="ipFilterEnabled" class="form-checkbox bg-gray-800 border-gray-700 text-blue-600 rounded">
          <label for="ipFilterToggleEvents" class="text-gray-300 text-xs md:text-sm cursor-pointer">Hide blocked IPs</label>
        </div>
        ...
        <table class="w-full text-left">
          ...
          <tbody>
            <tr v-for="evt in events" :key="evt._id" class="border-b border-gray-800/50 hover:bg-gray-800/30">
              ...
              <td class="px-2 md:px-3 py-2 md:py-3 text-gray-400 text-xs md:text-sm font-mono">{{ evt.ip || '—' }}</td>
